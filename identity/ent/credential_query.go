...
func (_q *CredentialQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Credential, error) {
	...
	if query := _q.withPrincipal; query != nil {
		if err := _q.loadPrincipal(ctx, query, nodes, nil,
			func(n *Credential, e *Principal) { n.Edges.Principal = e }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *CredentialQuery) loadPrincipal(ctx context.Context, query *PrincipalQuery, nodes []*Credential, init func(*Credential), assign func(*Credential, *Principal)) error {
...
func (_q *CredentialQuery) querySpec() *sqlgraph.QuerySpec {
	...
	if fields := _q.ctx.Fields; len(fields) > 0 {
		...
		if _q.withPrincipal != nil {
			_spec.Node.AddColumnOnce(credential.FieldPrincipalID)
		}
	}
