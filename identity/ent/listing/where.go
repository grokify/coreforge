...
func ProductIDGT(v uuid.UUID) predicate.Listing {
	return predicate.Listing(sql.FieldGT(FieldProductID, v))
}

// ProductIDGTE applies the GTE predicate on the "product_id" field.
func ProductIDGTE(v uuid.UUID) predicate.Listing {
	return predicate.Listing(sql.FieldGTE(FieldProductID, v))
}

// ProductIDLT applies the LT predicate on the "product_id" field.
func ProductIDLT(v uuid.UUID) predicate.Listing {
	return predicate.Listing(sql.FieldLT(FieldProductID, v))
}

// ProductIDLTE applies the LTE predicate on the "product_id" field.
func ProductIDLTE(v uuid.UUID) predicate.Listing {
	return predicate.Listing(sql.FieldLTE(FieldProductID, v))
}
...
func HasCreatorOrg() predicate.Listing {
	return predicate.Listing(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			...
			sqlgraph.Edge(sqlgraph.M2O, true, CreatorOrgTable, CreatorOrgColumn),
		)
