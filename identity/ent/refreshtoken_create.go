...
func (_c *RefreshTokenCreate) check() error {
	...
	if _, ok := _c.mutation.Family(); !ok {
		return &ValidationError{Name: "family", err: errors.New(`ent: missing required field "RefreshToken.family"`)}
	}
...
func (u *RefreshTokenUpsert) SetFamily(v string) *RefreshTokenUpsert {
	u.Set(refreshtoken.FieldFamily, v)
	return u
}
...
func (u *RefreshTokenUpsert) UpdateFamily() *RefreshTokenUpsert {
	u.SetExcluded(refreshtoken.FieldFamily)
	return u
}
...
// SetFamily sets the "family" field.
func (u *RefreshTokenUpsertOne) SetFamily(v string) *RefreshTokenUpsertOne {
	return u.Update(func(s *RefreshTokenUpsert) {
		s.SetFamily(v)
	})
}
...
// SetFamily sets the "family" field.
func (u *RefreshTokenUpsertBulk) SetFamily(v string) *RefreshTokenUpsertBulk {
	return u.Update(func(s *RefreshTokenUpsert) {
		s.SetFamily(v)
	})
}
...
// UpdateFamily sets the "family" field to the value that was provided on create.
func (u *RefreshTokenUpsertBulk) UpdateFamily() *RefreshTokenUpsertBulk {
	return u.Update(func(s *RefreshTokenUpsert) {
		s.UpdateFamily()
	})
}
