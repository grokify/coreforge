...
func (_d *OAuthAppDelete) sqlExec(ctx context.Context) (int, error) {
	_spec := sqlgraph.NewDeleteSpec(oauthapp.Table, sqlgraph.NewFieldSpec(oauthapp.FieldID, field.TypeUUID))
...
// Where appends a list predicates to the OAuthAppDelete builder.
func (_d *OAuthAppDeleteOne) Where(ps ...predicate.OAuthApp) *OAuthAppDeleteOne {
...
func (_d *OAuthAppDeleteOne) Exec(ctx context.Context) error {
	...
	case err != nil:
		return err
	case n == 0:
		return &NotFoundError{oauthapp.Label}
	default:
		return nil
	}
}
