...
func (*OAuthConsent) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case oauthconsent.FieldScopes:
			values[i] = new([]byte)
		case oauthconsent.FieldGranted, oauthconsent.FieldRevoked:
			values[i] = new(sql.NullBool)
		case oauthconsent.FieldRevokedReason:
			values[i] = new(sql.NullString)
		case oauthconsent.FieldGrantedAt, oauthconsent.FieldLastUsedAt, oauthconsent.FieldRevokedAt, oauthconsent.FieldCreatedAt, oauthconsent.FieldUpdatedAt:
			values[i] = new(sql.NullTime)
		case oauthconsent.FieldID, oauthconsent.FieldUserID, oauthconsent.FieldAppID:
...
func (_m *OAuthConsent) QueryApp() *OAuthAppQuery {
	return NewOAuthConsentClient(_m.config).QueryApp(_m)
}
