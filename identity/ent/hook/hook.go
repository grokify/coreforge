...
// The OAuthAppSecretFunc type is an adapter to allow the use of ordinary
// function as OAuthAppSecret mutator.
type OAuthAppSecretFunc func(context.Context, *ent.OAuthAppSecretMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f OAuthAppSecretFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.OAuthAppSecretMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.OAuthAppSecretMutation", m)
}
...
// The ServiceAccountKeyPairFunc type is an adapter to allow the use of ordinary
// function as ServiceAccountKeyPair mutator.
type ServiceAccountKeyPairFunc func(context.Context, *ent.ServiceAccountKeyPairMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f ServiceAccountKeyPairFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.ServiceAccountKeyPairMutation); ok {
		return f(ctx, mv)
	}
