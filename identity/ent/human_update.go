...
func (_u *HumanUpdate) sqlSave(ctx context.Context) (_node int, err error) {
	...
	if _u.mutation.GivenNameCleared() {
		_spec.ClearField(human.FieldGivenName, field.TypeString)
	}
	...
	if _u.mutation.FamilyNameCleared() {
		_spec.ClearField(human.FieldFamilyName, field.TypeString)
	}
	...
	if _u.mutation.LocaleCleared() {
		_spec.ClearField(human.FieldLocale, field.TypeString)
	}
	...
	if _u.mutation.TimezoneCleared() {
		_spec.ClearField(human.FieldTimezone, field.TypeString)
	}
