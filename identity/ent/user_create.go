...
func (_c *UserCreate) AddOauthAuthCodeIDs(ids ...uuid.UUID) *UserCreate {
	_c.mutation.AddOauthAuthCodeIDs(ids...)
	return _c
}
...
func (_c *UserCreate) AddOauthAuthCodes(v ...*OAuthAuthCode) *UserCreate {
	...
	return _c.AddOauthAuthCodeIDs(ids...)
}
...
func (_c *UserCreate) AddCreatedServiceAccountIDs(ids ...uuid.UUID) *UserCreate {
	_c.mutation.AddCreatedServiceAccountIDs(ids...)
	return _c
}
...
func (_c *UserCreate) AddCreatedServiceAccounts(v ...*ServiceAccount) *UserCreate {
	...
	return _c.AddCreatedServiceAccountIDs(ids...)
}
...
func (_c *UserCreate) createSpec() (*User, *sqlgraph.CreateSpec) {
	...
	if nodes := _c.mutation.OauthAuthCodesIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
	...
	if nodes := _c.mutation.CreatedServiceAccountsIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
